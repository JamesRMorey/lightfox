...
import { faGlobe, faRocket, faBook, faImage, faSave, faRightLeft, faRotateRight, faRotateLeft, faCrop, faUpRightFromSquare, faExclamation, faFilter, faMap, faHeartBroken, faPaw, faPersonFalling, faLeaf, faSpa, faHouseFlag, faPerson, faFaceGrinStars, faWater, faPersonSwimming, faSnowflake, faTree, faCow, faPersonHiking, faMountain, faBinoculars, faHillRockslide, faFaceMehBlank, faChair, faEye, faHeart, faTent, faHamburger, faUser, faEdit, faAdd, faRemove, faCamera, faCameraRetro, faUpload, faArrowLeft, faArrowRight, faChevronLeft, faChevronRight, faM, faS } from '@fortawesome/free-solid-svg-icons'
import { faInstagram, faApple, faAppStoreIos, faGoogle, faFacebook } from '@fortawesome/free-brands-svg-icons';
